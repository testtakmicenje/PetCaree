...
public class FitnesIAktivnosti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fitnes_aktivnosti_activity);
        ...
        addWeightButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(FitnesIAktivnosti.this, ActivityPermission.class);
    ...
    private void showEmployeesFromDatabase() {
        ...
        List<Fitnes> workersListModelList = new ArrayList<>();

        if (cursorproduct.moveToFirst()) {

            do {

                workersListModelList.add(new Fitnes(
        ...
        adapter = new FitnesAdapter(this, R.layout.prehana_list_item, workersListModelList, mDatabase);
