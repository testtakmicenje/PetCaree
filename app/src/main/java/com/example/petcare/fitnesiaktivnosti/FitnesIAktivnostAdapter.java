...
public class FitnesIAktivnostAdapter extends RecyclerView.Adapter<FitnesIAktivnostAdapter.ProductViewHolder> {
    ...
    public FitnesIAktivnostAdapter(Context context, int custom_list_item, List<Ljubimac> myJobsAndMyProjectsListModel, SQLiteDatabase mDatabase) {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.fitnes_adapter, null);
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        ...
        holder.deletebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                builder.setMessage(Html.fromHtml("<font color='#3B3B3B'>Da li si siguran da želiš izbirsati ovu fitnes i aktivnost?</font>"));

                builder.setPositiveButton("Izbriši", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String sql = "DELETE FROM Fitnes2 WHERE id = ?";
                        ...
                        showToast("Evidencija fitnesa i aktivnosti je obrisana.");
                    }
                });
    ...
    void reloadEmployeesFromDatabase() {
        Cursor cursorproduct1 = mDatabase.rawQuery("SELECT * FROM Fitnes2", null);
