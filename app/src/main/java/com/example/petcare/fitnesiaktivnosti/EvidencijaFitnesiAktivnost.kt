...
class EvidencijaFitnesiAktivnost() : AppCompatActivity() {
    ...
    private val channelId = "channelId2"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.evidencija_fitnes_activity)
        ...
        addpodsjetnik!!.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                ...
                if (email.isEmpty()) {
                    ...
                    val insertSQL = ("INSERT INTO Fitnes2 \n" +
                            "(Email, Vrijeme)\n" +
                            "VALUES \n" +
                            "(?, ?);")
                    ...
                    val intent = Intent(this@EvidencijaFitnesiAktivnost, FitnesIAktivnost::class.java)
    ...
    private fun showToast(message: String) {
        Toast.makeText(this@EvidencijaFitnesiAktivnost, message, Toast.LENGTH_SHORT).show()
    }

    private fun scheduleNotification(timeInMillis: Long) {
        val notificationIntent = Intent(this, NotificationPublisherFitnes::class.java)
            ...
            object : OnDateSetListener {
                override fun onDateSet(
                    ...
                    val timePickerDialog = TimePickerDialog(
                        this@EvidencijaFitnesiAktivnost, R.style.DatePickerTheme,
    ...
    private fun getNotification(content: String): Notification {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "2"
            val channelName: CharSequence = "Notification2"
