...
import com.example.petcare.databinding.NotificationItemBinding
        ...
        fun bind(notification: Notification) {
            ...
            itemBinding.root.setOnClickListener { view ->
                ...
                if (notification.isPost) {
                    ...
                    itemBinding.root.context.getSharedPreferences("PREFS", Context.MODE_PRIVATE).edit().putString("postid", notification.postid).apply()

                    view.findNavController().navigate(R.id.action_notificationFragment_to_postDetailFragment)

                } else {

                    itemBinding.root.context.getSharedPreferences("PROFILE", Context.MODE_PRIVATE).edit().putString("profileId", notification.userid).apply()
                ...
                .addValueEventListener(
                    ...
                    object : ValueEventListener {
                        ...
                        override fun onDataChange(dataSnapshot: DataSnapshot) {
                            ...
                            Picasso.get().load(post.imageurl).placeholder(R.drawable.userprofilepictureplaceholder).into(postImage)
